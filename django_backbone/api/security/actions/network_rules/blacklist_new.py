...
# > Handler
# --------------------------------------------------------------------------------
class NewBlacklistNetworkRuleHandler(ActionHandler):
    """Creates a new NetworkRule and blacklists its IP"""
    ...
    def main(self):
        """
        Creates and blacklists the NetworkRule model with the provided data
